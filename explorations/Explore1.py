...
ax = sns.lineplot(x="time", y="value", hue="type", data=hh_p)
...
plot_data = pd.merge(hh_p_preaug, mm_p_preaug, how="outer", on="time").melt(
    id_vars=["time", "type"], var_name="name", value_name="values"
)
# %%
